...
- Snapshots: fail closed for symlinks, submodules, unsupported binaries and path traversal. The MVP does not preserve executable permissions in exported test snapshots.
